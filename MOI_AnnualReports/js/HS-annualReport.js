for (var i = new Date().getFullYear(); i > 1999; i--) {
  ...
  //jquery years - End
$("#govBtn, #monthDiv, #tbl_gov_div, #tbl_months_div").hide();
// Flat picker
...
$(document).ready(function () {
	...
	// Willayt Wise
	var tsMajorMinorTable = new DataTable('#tsMajorMinorTable', {
		dom: '<"top"f>rt<"bottom"ilp>',
		info: false,
		ordering: false,
		paging: false,
	...
	$('#export').on('click', function () {
		tsMajorMinorTable.button(0).trigger();
	});
	$('#excel').on('click', function () {
		tsMajorMinorTable.button(1).trigger();
	});
	...
	//Month wise
	var tbl_months_report = new DataTable('#tbl_months_report', {
		dom: '<"top"f>rt<"bottom"ilp>',
		info: false,
		ordering: false,
		paging: false,
	...
	$('#exportMonth').on('click', function () {
		tbl_months_report.button(0).trigger();
	});
	$('#excelMonth').on('click', function () {
		tbl_months_report.button(1).trigger();
	});
...
$("#caseSubTypeId").change(function () {
	...
	if (caseSubType == 10369 || caseSubType == 10370) {
		$("#govBtn, #tbl_gov_div1, #generateReportBtn").show();
		$("#monthDiv, #tbl_months_div, #export, #exportMonth").hide();
	} else if (caseSubType == 10371 || caseSubType == 10372) {
		$("#govBtn, #tbl_gov_div, #export, #exportMonth, #generateReportBtn").hide();
		$("#monthDiv, #tbl_months_div1").show()
	} else {
		$("#govBtn, #monthDiv, #tbl_gov_div, #tbl_months_div, #export, #exportMonth").hide();
	}
});
...
$("#generateReportServiceBtn").click(function () {
	$(this).hide();
	$("#ts_details").hide();
	$("#tbl_months_div, #exportMonth").show();
});
// Generate Table for Government Services Report //
$("#yearRangeDiv, #monthRangeDiv, .dateRangeDiv").hide();
$("#reportType").change(function () {
	if (this.value == '1') {
		$("#yearRangeDiv").show();
		$("#monthRangeDiv, .dateRangeDiv").hide();
	} else if (this.value == "2") {
		$("#monthRangeDiv").show();
		$("#yearRangeDiv, .dateRangeDiv").hide();
	} else if (this.value == "3") {
		$(".dateRangeDiv").show();
		$("#yearRangeDiv, #monthRangeDiv").hide();
	} else {
		$("#yearRangeDiv, #monthRangeDiv, .dateRangeDiv").hide();
	}
});
